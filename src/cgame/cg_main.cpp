...
Cvar::Cvar<bool> cg_minimapRotate("cg_minimapRotate", "whether to rotate the minimap with the player's view", Cvar::NONE, false);
...
Cvar::Cvar<bool> cg_drawEntityInfo("cg_drawEntityInfo", "show number and type of facing entity", Cvar::NONE, false);
